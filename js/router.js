...
export class Router {
    ...
    async _navigate(rawPath, pushState = true) {
        ...
        // Redirect legacy pages to settings tabs
        if (path === '/logs') {
            window.app = window.app || {};
            window.app.configDefaultTab = 'logs';
            this.push('/configuracoes');
            return;
        }
        if (path === '/informacoes') {
            window.app = window.app || {};
            window.app.configDefaultTab = 'informacoes';
            this.push('/configuracoes');
            return;
        }
